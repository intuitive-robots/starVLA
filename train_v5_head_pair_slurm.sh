#!/bin/bash
#SBATCH --job-name=tr_v5_pair
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH --gres=gpu:4
#SBATCH --time=12:00:00
#SBATCH --output=slurm_logs/train_v5_pair_%j.out
#SBATCH --error=slurm_logs/train_v5_pair_%j.err
...
echo "=========================================="
echo " v5 backbone head comparison -- seed ${SEED}"
echo " Job ${SLURM_JOB_ID:-local} on $(hostname)"
echo " slot 0  GPUs 0,1  PI      ervla_v5_pi_actiononly_pifix_s${SEED}"
echo " slot 1  GPUs 2,3  GR00T   ervla_v5_gr00t_actiononly_s${SEED}"
echo "=========================================="
...
launch() {
    ...
    port=$((37000 + slot))
    log="slurm_logs/train_v5_pair_${SLURM_JOB_ID:-local}_${arm}.log"
...
launch 0 pi    "$PI_YAML" "ervla_v5_pi_actiononly_pifix_s${SEED}"
launch 1 gr00t "$GR_YAML" "ervla_v5_gr00t_actiononly_s${SEED}"
