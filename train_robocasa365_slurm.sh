#!/bin/bash
#SBATCH --job-name=starvla_robocasa365
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH --gres=gpu:4
#SBATCH --time=09:30:00
#SBATCH --output=slurm_logs/robocasa365_%j.out
#SBATCH --error=slurm_logs/robocasa365_%j.err
...
STARVLA_REPO=${STARVLA_REPO:-/e/project1/m3/blank4/code/starVLA-upstream-merge}
cd "$STARVLA_REPO"

# ── Parse --config; collect remaining args as CLI overrides ──────────────

CONFIG_YAML="./examples/simBenchmarks/Robocasa_365/train_files/starvla_qwenoft_robocasa365_v3_atomic.yaml"
...
preflight_ok=1
for d in "${STARVLA_REPO}" "/e/scratch/m3/blank4" "/e/home/jusers/blank4/jupiter/datasets/lerobot_3_0/robocasa365_target_atomic"; do
