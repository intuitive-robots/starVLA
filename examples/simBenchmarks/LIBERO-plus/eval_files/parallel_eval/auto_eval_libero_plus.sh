...
# examples/simBenchmarks/LIBERO-plus/eval_files/parallel_eval, exactly four levels below the
...
if [ "${skip_aggregate}" != "true" ]; then
    ...
    #   python examples/simBenchmarks/LIBERO-plus/eval_files/parallel_eval/aggregate_results.py --root_path <output_dir>
