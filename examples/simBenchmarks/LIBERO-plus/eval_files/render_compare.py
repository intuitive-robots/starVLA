...
Usage (GPU/EGL):
    ...
    python examples/simBenchmarks/LIBERO-plus/eval_files/render_compare.py --tag egl
...
Usage (Mesa/CPU):
    ...
    python examples/simBenchmarks/LIBERO-plus/eval_files/render_compare.py --tag mesa
"""
import argparse
import os
import pathlib
