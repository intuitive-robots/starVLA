...
#   bash examples/simBenchmarks/LIBERO/eval_files/parallel_eval/auto_eval_libero.sh libero_goal 4 3 50
#
...
SHARD_SCRIPT="./examples/simBenchmarks/LIBERO/eval_files/parallel_eval/eval_libero_shard.py"
